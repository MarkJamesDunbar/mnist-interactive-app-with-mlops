...
push-hub: 
	...
	huggingface-cli upload MarkJamesDunbar/Drug-Classification ./app/model --repo-type=space --commit-message="Sync Model"
	huggingface-cli upload MarkJamesDunbar/Drug-Classification ./model_reporting /model_reporting --repo-type=space --commit-message="Sync Model"
